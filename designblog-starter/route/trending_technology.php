...
// Query untuk mendapatkan artikel kategori "technology" yang diurutkan berdasarkan "views" terbanyak
$sql = "SELECT * FROM artikel WHERE kategori = 'technology' ORDER BY views DESC LIMIT 5";
$result = $conn->query($sql);
?>

<div class="trending-technology">
    <?php if ($result->num_rows > 0): ?>
        ...
        <?php endwhile; ?>
    <?php else: ?>
        <p>Tidak ada artikel trending di kategori technology saat ini.</p>
    <?php endif; ?>
</div>
