...
// Tentukan jumlah artikel per halaman untuk kategori lifestyle
$articlesPerPage = 5;
...
// Query untuk mendapatkan total artikel dengan kategori "lifestyle"
$totalArticlesSql = "SELECT COUNT(*) as total FROM artikel WHERE kategori = 'lifestyle'";
...
// Query untuk mendapatkan artikel kategori "lifestyle" pada halaman saat ini
$sql = "SELECT * FROM artikel WHERE kategori = 'lifestyle' ORDER BY tanggal_publikasi DESC LIMIT $offset, $articlesPerPage";
...
<div class="row">
    <?php if ($result->num_rows > 0): ?>
        ...
        <?php endwhile; ?>
    <?php else: ?>
        <p>Tidak ada artikel dengan kategori lifestyle yang tersedia.</p>
    <?php endif; ?>
</div>
